...
module Range_finder = Sample.Range_finder
module Harness = Cyclesim_harness.Make (Range_finder.I) (Range_finder.O)

let ( <--. ) = Bits.( <--. )
let sample_input_values = [ 16; 67; 150; 99; 4 ]
...
let%expect_test "Simple test, optionally saving waveforms to disk" =
  ...
  [%expect {|
    (Result (range 146))
    Saved waves to /tmp/test_range_finder_ml_Simple_test__optionally_saving_waveforms_to_disk.vcd
    |}]
;;
...
let%expect_test "Simple test with printing waveforms directly" =
  ...
  [%expect
    ...
    │                            ││  └─┘ └─┘ └─┘ └─┘ └─┘ └─┘ └─┘ └─┘ └─┘ └─┘ └─┘ └─┘ └─┘ └─┘ └─│
    │                            ││────────────┬───────┬───────┬───────┬───────┬───────────────│
    │range_finder$i$data_in      ││ 0          │16     │67     │150    │99     │4              │
    │                            ││────────────┴───────┴───────┴───────┴───────┴───────────────│
